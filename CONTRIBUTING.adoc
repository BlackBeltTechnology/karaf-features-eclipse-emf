# Contributing to karaf-features-eclipse-emf

## Installing the correct versions of Java, Maven and necessary dependencies

karaf-features-eclipse-emf is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/karaf-features-eclipse-emf/issues/new/choose[issue form].
